    ...
    <div style={{ minHeight: '100vh', background: '#F3F4F6' }} className="bg-grid flex items-center justify-center px-4">
      <div className="relative w-full max-w-md">
        ...
        <div className="rounded-2xl p-8" style={{ background: '#FFFFFF', border: '1px solid #E2E8F0', boxShadow: '0 4px 24px rgba(0,0,0,0.08)' }}>
          {isPending && (
            <div className="flex items-start gap-3 px-4 py-3 rounded-lg mb-4" style={{ background: 'rgba(217,119,6,0.08)', border: '1px solid rgba(217,119,6,0.25)' }}>
              <Clock className="w-5 h-5 mt-0.5 shrink-0" style={{ color: '#D97706' }} />
              <div>
                <p className="text-sm font-medium" style={{ color: '#D97706' }}>Account pending approval</p>
          ...
          <p className="text-center text-sm mt-6" style={{ color: '#64748B' }}>
            ...
            <Link href="/register" style={{ color: '#FF9900' }} className="font-medium hover:underline">Sign up</Link>
          </p>
        </div>
      </div>
    </div>
